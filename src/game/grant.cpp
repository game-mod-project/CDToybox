// @build 1.0.0.2944  kGoodDriveSites 에 2944 자리(0x2AD105D)를 넣었다 - 정적
//   으로는 못 가려(액터 조회 호출 681곳) ini `drive_sites` 로 넣어 굴린 뒤
//   성공 경로 로그로 확인한 값이다. 2850 자리도 함께 둔다.
...
constexpr std::uint64_t kGoodDriveSites[] = {0x2A03D7D, 0x2AD105D};
