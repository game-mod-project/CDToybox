// @build 1.0.0.2976  관문 둘 재도출(2026-09-26) - 관문0 +0xA1D90 · 관문1 +0x50.
//   창 8바이트는 둘 다 그대로이고 함수 크기도 4437바이트로 같다. 근거: specs/2026-09-26-game-update-2976.md §8
// @build 1.0.0.2949  관문 둘 재도출(2026-09-22). 창 8바이트는 2850·2944 와 동일(자리만
//   밀렸다) - 관문0 0xE808870 -> 0xE3F9650, 관문1 0x2140CF9 -> 0x2140D09.
...
//
// 1.0.0.2949(2026-09-22), 같은 경로로 다시 내려갔다: 슬롯 +0x6CF7BF0 을 읽는 곳은 실행
// 섹션 전량에서 **0x2140AFC 한 곳**이고, 그 함수 0x2140740~0x2141895 는 2944 의
// CheckLearnOrLevelUp 과 크기(4437바이트)까지 같다. 직전 `call 썽크 0x2140650` 의 jmp
// 목적지 0xE3F9650 = 관문0(함수 시작, 창 일치), 같은 함수의 `setge byte [rsp+0x40]`
// 0x2140D09 = 관문1(창 일치). (2944 자리: 관문0 0x0E808870 · 관문1 0x02140CF9)
