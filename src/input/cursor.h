...
// 기억해 두고 0 으로 맞추며(창 안의 포인터는 ImGui 소프트 커서다 - 이 값은 창 밖에서
// 보이게 하는 것), 닫힐 때 기억한 값에 그 사이 게임이 바꾼 만큼을 얹어 되돌리고,
// 가두기는 게임의 마지막 요청(cursor_clip_restore)대로 한다. 열려 있는 동안은
// 카운터를 건드리지 않는다. 열고 닫을 때 한 줄씩 진단을 남긴다(카운터·가두기 판정·
// 막은/통과 호출 수·열린 프레임 수).
