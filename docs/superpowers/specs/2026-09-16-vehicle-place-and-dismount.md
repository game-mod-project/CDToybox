...
>
> ➡️ **2026-09-21 원인 자리** — 캐릭터 **행동 제한 목록**의 허용 스킬그룹 목록이
> 호출 스킬 판정(`0x362DF0`, 행동 차트 조건 0xED)을 막는다. 아래 §8-2 의 두 패치가
> 무반응이었던 것은 조건 **체계**가 달라서다(AI 차트 ≠ 행동 차트).
