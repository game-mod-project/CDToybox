...
|---|---|---|---|---|---|---|
| Main | CDToybox | — | 열림 | 60,60 | 360×260 | 320×200 |
| Items | 아이템 목록 | 아이템 목록 | 열림 | **440**,60 | 760×520 | 430×240 |
| Grant | 아이템 지급 | 아이템 지급 | 열림 | 1220,60 | 440×260 | 420×260 |
| Stash | 보관함 | 보관함 | 열림 | 1220,340 | 420×400 | 420×300 |
| Inventory | 인벤토리 | 인벤토리 | 열림 | 440,600 | 760×420 | 720×300 |
| Roster | 탈것 · 용병 · 캐릭터 | 탈것·용병·캐릭터 | 닫힘 | 60,340 | 560×520 | 560×360 |
| Equip | 장비 소켓 · 연마 · 염색 | 장비 소켓·연마·염색 | 닫힘 | 640,340 | 560×420 | 560×300 |
| Player | 플레이어 치트 | 플레이어 치트 | 닫힘 | 1220,760 | 320×220 | 320×220 |
...
**본창 (`overlay.cpp`)**
- 체크박스 8개를 배치 표의 `label` 로, 2열 격자(`SameLine(190)`). 순서: 아이템 목록 ·
