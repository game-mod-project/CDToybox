...
> **정리 (2026-09-21) — 📐 설계 → 구현됨.** 필터바 · 필터 술어 · 보석 선택기 전부
> 들어왔다(`plans/2026-09-10-panel-shared-widgets.md`, `STATUS.md` §1.14). 검토에서 둘이
> 바로잡혔다 — 보석 선택기 상태는 static 하나가 아니라 창마다 하나, 시험 기준선은 364 가
> 아니라 375(`2026-09-10-panel-shared-widgets-review.md`).
