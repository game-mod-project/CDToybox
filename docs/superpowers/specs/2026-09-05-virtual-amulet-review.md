...
> **정리 (2026-09-21) — ❌ 반증.** §1 · §4 의 "가상 부적이 가능해 보인다 · 권장" 은 같은
> 날 §8 라이브 검증이 전제(스킬 → SummonBuffData → SummonCharacterData)를 뒤집었다.
> 부적 사용(2676)은 고용 작업을 부르지 않아 흉내 내는 길이 막혔고
> (`2026-09-05-companion-summon-acquire-design.md`), 목적(부적 없는 종 등록)은 2338
> 획득으로 풀렸다.
