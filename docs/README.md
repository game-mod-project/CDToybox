...
| [game-update-2976](superpowers/specs/2026-09-26-game-update-2976.md) | ✅ 상수 이관 · 효과 표 재생성 · 게임 대조(효과 6줄 · 어비스 2/5/7%) | 41개 중 36개 이동. callgate 둘은 창의 전역 변위 때문에 슬롯에서 재도출. 지급 구동 자리만 게임 확인 남음 |
