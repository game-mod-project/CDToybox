...
.\build\cdtb_tests.exe       # 단위 시험 — 끝줄의 `0 failures` 를 볼 것 (888개, 2026-09-23)
...
| `docs/superpowers/plans/` | 단계별 구현 계획 (8편 — 6편 구현 완료, 1단계 계획은 값 스캐너만 완료·카메라 보류, 아이템 효과 계획은 구현 완료·게임 확인 전. 머리말 배너를 볼 것) |
